...
export default function WeddingServicePage() {
  ...
  return (
    <>
      <Helmet>
        <title>Luxury Wedding Decor & Celebration Services</title>
        <meta
          name="description"
          content="Riwaaz India offers mandap design, baraat arrangements, floral decor, catering, photography, sangeet setups, and engagement decor in Delhi NCR."
        />
      </Helmet>

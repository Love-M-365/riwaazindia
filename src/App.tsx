...
import video2 from "./4.mp4";
import video4 from "./5.mp4";
import image1 from "./img1.jpeg";
import image2 from "./img2.png";
import auris from "./auris.jpeg";
...
const Gallery = () => {
  const items = [
    { type: 'video', url: video1, title: "The Union", category: "INDIA" },
    { type: 'image', url: image1, title: "Royal Mandap", category: "Decor" },
    { type: 'video', url: video4, title: "Eternal Walk", category: "Wedding" },
    { type: 'image', url: image2, title: "Spiritual Night", category: "Jagran" },
    
    { type: 'video', url: video2, title: "Celebration", category: "Party" },
    { type: 'image', url: image4, title: "Divine Grace", category: "Mata Chowki" },
    ...
    <section id="gallery" className="py-20 md:py-40 bg-warm-bg relative overflow-hidden">
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-24">
          ...
          <h2 className="text-5xl md:text-8xl font-display mb-8 tracking-tighter">Grand <span className="italic font-serif text-primary">Showcase</span></h2>
          <div className="ornate-divider max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {items.map((item, i) => (
            <motion.div 
              ...
              className={`relative overflow-hidden rounded-[2.5rem] group cursor-pointer elegant-shadow royal-border royal-border-tl royal-border-br ${
                i === 0 ? 'sm:col-span-2 sm:row-span-2 aspect-[4/5]' : 'aspect-square'
              } ${i === 2 ? 'sm:col-span-2 aspect-[16/9]' : ''}`}
            >
              {item.type === 'video' ? (
                <video 
                  src={item.url} 
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-primary/90 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col justify-end p-8 md:p-12">
                <span className="text-secondary text-[10px] font-bold tracking-[0.4em] uppercase mb-4">{item.category}</span>
                <h3 className="text-white font-display text-2xl md:text-4xl">{item.title}</h3>
              </div>
            </motion.div>
          ))}
        </div>
      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative max-w-4xl w-full bg-white rounded-[2rem] md:rounded-[3rem] overflow-hidden shadow-[0_30px_100px_rgba(0,0,0,0.5)] royal-border royal-border-tl royal-border-tr royal-border-bl royal-border-br my-auto"
          >
            <button 
              onClick={() => setIsOpen(false)}
    ...
    <div className="container mx-auto px-6 relative z-10">
      <div className="text-center mb-24">
        ...
        <motion.h2 
          ...
          className="text-6xl md:text-9xl font-display mb-8 tracking-tighter"
        >
      ...
      <div className="grid lg:grid-cols-12 gap-12 items-stretch max-w-7xl mx-auto">
        ...
        >
          <div className="h-full bg-white rounded-[4rem] overflow-hidden shadow-[0_50px_100px_rgba(0,0,0,0.08)] border border-secondary/40 relative">
            ...
            <div className="absolute top-10 left-10 z-20">
              <span className="gold-gradient text-primary px-6 py-2 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] shadow-lg">
                The Royal Choice
              </span>
            </div>
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="p-10 md:p-16 flex-1 flex flex-col">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
                  {[
                    { label: 'Marriage', val: '300' },
                    { label: 'Ring', val: '100' },
                    { label: 'Haldi', val: '100' },
                    { label: 'Cocktail', val: '100' }
                  ].map((item) => (
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                  <div className="space-y-4">
                    ...
                    {[
                      'Majestic Home Decor Artistry',
                      'Bespoke Digital Invitations',
                      'Elite Silver Service Staff',
                  ...
                  <div className="space-y-4">
                    ...
                    {[
                      'Free Travel for 20 Guests',
                      'Premium Floral Stage Decor',
        ...
        {/* OFFER 2: THE COMPREHENSIVE LUXURY */}
        <motion.div 
          initial={{ opacity: 0, x: 30 }}
          whileInView={{ opacity: 1, x: 0 }}
              ...
              <div className="space-y-8 mb-12">
                <div className="p-8 rounded-3xl bg-white/5 border border-white/10">
                  ...
                  <p className="text-white/60 font-light leading-relaxed mb-6">
                    A seamless blend of prestige and flexibility. This package grants you access to:
                  </p>
                  <ul className="space-y-4">
                    {[
                      'A Grand Function at Auris Luxury',
                      '3 Functions in 50+ Elite Venues',
                      'Banquets, Farmhouses & Hotels',
                      'Available across entire Delhi NCR',
                      'Ultra-Luxury Decor & Catering',
                      'Personalized Event Director'
                    ].map((item) => (
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-24 md:mb-32">
          ...
          <motion.h2 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.1 }}
            className="text-5xl md:text-9xl font-display tracking-tighter mb-8"
          >
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-white rounded-[3rem] md:rounded-[4rem] overflow-hidden elegant-shadow flex flex-col lg:flex-row group royal-border royal-border-tl royal-border-tr"
          >
            <div className="lg:w-1/2 h-80 sm:h-96 lg:h-auto overflow-hidden relative">
              <img src={hall.image} alt={hall.name} className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" referrerPolicy="no-referrer" />
            ...
            <div className="lg:w-1/2 p-10 md:p-16 lg:p-20 flex flex-col justify-center">
              ...
              <div className="flex flex-wrap gap-4 mb-12">
                {hall.features.map((f, j) => (
                  <span key={j} className="text-[10px] px-6 py-3 bg-primary/5 text-primary rounded-full uppercase font-bold tracking-[0.2em] border border-secondary/20">
                    {f}
                  </span>
                ))}
              </div>
...
const ContactForm = () => {
  ...
  return (
    <section id="contact" className="py-20 md:py-40 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto glass-card rounded-[4rem] overflow-hidden flex flex-col lg:flex-row royal-border royal-border-tl royal-border-tr royal-border-bl royal-border-br">
              ...
              {status === 'sent' ? (
                ...
                >
                  ...
                  <button 
                    ...
                    className="mt-8 md:10 text-secondary font-bold uppercase text-xs tracking-[0.3em] border-b border-secondary pb-1"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-10">
                  <div className="grid md:grid-cols-2 gap-10">
                    <div className="space-y-4">
                      ...
                      <input 
                        ...
                        className="w-full bg-transparent border-b-2 border-gray-100 py-4 px-2 focus:border-secondary transition-colors outline-none text-lg font-light" 
                  ...
                  <div className="space-y-4">
                    ...
                    <select 
                      ...
                      className="w-full bg-transparent border-b-2 border-gray-100 py-4 px-2 focus:border-secondary transition-colors outline-none text-lg font-light appearance-none cursor-pointer"
                    >
                  ...
                  <div className="space-y-4">
                    ...
                    <textarea 
                      ...
                      className="w-full bg-transparent border-b-2 border-gray-100 py-4 px-2 focus:border-secondary transition-colors outline-none text-lg font-light resize-none" 
                      placeholder="Describe your royal vision..."
                    ></textarea>
                  </div>
                  <button 
                    disabled={status === 'sending'}
                    type="submit" 
                    className="w-full gold-gradient text-primary py-6 rounded-full text-xl font-display font-bold hover:scale-[1.02] transition-all shadow-2xl active:scale-95 disabled:opacity-50 flex items-center justify-center gap-4 group"
                  >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
        <div className="space-y-10">
          ...
          <p className="text-gray-400 font-light leading-relaxed text-lg">
            Crafting royal legacies through timeless traditions and majestic celebrations. Your vision, our artistry.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-6">
            {['The Beginning', 'Our Craft', 'The Gallery', 'The Venues'].map((item) => (
              <li key={item}>
                <a href={`#${item.toLowerCase().replace(' ', '')}`} className="text-gray-400 hover:text-secondary transition-colors text-lg font-light">{item}</a>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-6">
            {['Mata Chowki', 'Jagran Nights', 'Royal Weddings', 'Grand Birthdays'].map((item) => (
              <li key={item}>
                <a href="#services" className="text-gray-400 hover:text-secondary transition-colors text-lg font-light">{item}</a>
              </li>
            ))}
          </ul>
        </div>
